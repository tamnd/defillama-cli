...
// HTTP behaviour is covered in defillama_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "defillama://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("defillama", "about")
	if err != nil || got.String() != "defillama://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want defillama://page/about", got.String(), err)
	}
}
