...
Most of these come down to network reality or how defillama serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

defillama rate-limits like any public site. defillama already paces
...
Where a surface is gated, defillama reads a cookie or token you supply
...
`defillama`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what defillama actually did
