...
```
defillama <command> [arguments] [flags]
```

Run `defillama <command> --help` for the full flag list on any command. This
...
per operation you declare in `defillama/domain.go`.
